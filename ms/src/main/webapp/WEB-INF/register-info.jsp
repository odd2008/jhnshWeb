...
<div class="hz">预约信息</div>
<hr style="border:1px solid #808080;margin-top:0px;clear:both">
<div><span class="ts">--温馨提示：请核实预约信息 </span><span style="float:right;color:blue">欢迎您，${name }</span></div>
<div style="height:350px;overflow:auto">

<c:choose>
	<c:when test="${empty regInfo }">
	...
	<c:otherwise>
		...
		<c:forEach items="${regInfo }" var="one">
			<tr>
				<td>
